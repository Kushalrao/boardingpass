...
const BOOKING_TYPE_PATTERNS: Record<BookingType, { subjects: string[]; domains: string[] }> = {
  flight: {
...
export function detectBookingType(subject: string, fromEmail: string): BookingType {
